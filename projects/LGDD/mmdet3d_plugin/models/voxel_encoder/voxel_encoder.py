...
from mmdet3d.models.voxel_encoders.utils import VFELayer, DynamicVFELayer, get_paddings_indicator
from ...utils import scatter_v2, get_activation_layer


@VOXEL_ENCODERS.register_module()
class CustomDynamicVFE(nn.Module):
    ...
    def __init__(self,
        ...
        super(CustomDynamicVFE, self).__init__()
...
@VOXEL_ENCODERS.register_module()
class CustomDynamicScatterVFE(CustomDynamicVFE):
    ...
    def __init__(self,
        ...
        super(CustomDynamicScatterVFE, self).__init__(
            in_channels,
            feat_channels,
            with_distance,
            with_cluster_center,
