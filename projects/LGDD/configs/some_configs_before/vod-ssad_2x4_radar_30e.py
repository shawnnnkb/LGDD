...
distill_setts = dict(use=False, semi=False, DCN=False, QPF_with_GNN=False, semantic_assist=True, point_supervision=dict(use=False, weight=0.1), radar_supervision=dict(use=False, weight=0.1),
...
# load_segmentor_from = '/home/yq/LGDD/projects/LGDD/checkpoints/vod-unet_seg_pretrain_4x4_24e/epoch_24.pth'
load_from = '/home/yq/LGDD/projects/LGDD/checkpoints/segmentor_load_pretrain.pth'
load_radar_from = '/home/yq/LGDD/projects/LGDD/checkpoints/vod-Radarpillarnet_8.20/epoch_24.pth'
resume_from = None
workflow = [('train', 1)]